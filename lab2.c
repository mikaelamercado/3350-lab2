        ...
        for(j=0;6.28>j;j+=0.07)   
            for(i=0;6.28>i;i+=0.02){
                float c=sin(i),
                      ...
                      f=sin(j),
                      g=cos(A),
                      width=d+2,    //width used to be h = d+2, 2 can be changed to any number to change the thickness of the donut. 
                      size=1/(c*width*e+f*g+5), // size used to be D=1/(c*h*e+f*g+5) is used to zoom in or make the donut appear larger in size. I can be changed to zoom in. 
                      l=cos(i),
                      m=cos(spinspeed),
                      n=sin(spinspeed),
                      t=c*width*g-f*e;  
                int x=40+30*size*(l*width*m-t*n), // x shifts te coordinates of the donut in the x axis
                    y=12+15*size*(l*width*n+t*m), // y shifts the coordinates of the donut in the y axis
                    o=x+80*y,
